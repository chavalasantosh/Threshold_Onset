...
from threshold_onset.phase1.boundary import detect_boundaries
from threshold_onset.phase1.cluster import cluster_residues
from threshold_onset.phase1.distance import pairwise_distances
from threshold_onset.phase1.pattern import detect_repetition, detect_survival
...
def phase1(residues):
    ...
    # Survival count — single-sequence call returns 0 (meaningful only for multi-seq).
    # Pass as a list of one sequence; the function handles this gracefully.
    survival_result = detect_survival([residues])
    ...
    return {
        ...
        'survival_count': survival_result.get('survival_count', 0),
    }
