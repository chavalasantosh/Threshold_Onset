...
def tokenize_text(text: str, tokenizer_type: str = "word", **kwargs: Any) -> List[Dict[str, Any]]:
    """Forward all kwargs (language, use_parallel, source_tag, etc.) to the core engine."""
    return _core_tokenize_text(text, tokenizer_type=tokenizer_type, **kwargs)
